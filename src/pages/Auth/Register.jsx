...
import { Mail, Lock, User, Sparkles, UserPlus, Zap } from 'lucide-react';
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-xs mt-1 font-sans">
            Get started with ElevateAI today
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800/80 rounded-2xl shadow-sm overflow-hidden p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-slate-900 hover:bg-slate-850 dark:bg-slate-100 dark:hover:bg-slate-200 text-white dark:text-slate-900 font-semibold rounded-xl text-sm transition-all flex items-center justify-center gap-2 hover:scale-[1.005] active:scale-[0.995] mt-2"
            >
              {loading ? (
        ...
        <p className="text-slate-550 dark:text-slate-400 text-xs text-center mt-6">
          ...
          <Link to="/login" className="text-indigo-600 dark:text-indigo-400 hover:underline font-semibold transition-all">
            Sign In
          </Link>
        </p>
      </div>
